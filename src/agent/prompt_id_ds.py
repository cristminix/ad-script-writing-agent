...
3.  **Kepatuhan Ketat pada Format:** Output akhir **HARUS** berupa objek JSON valid yang sesuai dengan skema yang disediakan, tanpa teks tambahan, header, penjelasan, atau komentar percakapan apapun.
